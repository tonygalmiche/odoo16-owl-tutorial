...
class TestOwl02 extends Component {
    setup() {
...
TestOwl02.components = { Layout, TodoList };
TestOwl02.template = "is_pic_3ans.test_owl_02_template";
registry.category("actions").add("is_pic_3ans.test_owl_02_registry", TestOwl02);
